...
#define D(fmt, ...) hvml_log_printf(__FILE__, __LINE__, __FUNCTION__, stderr, 'D', "%s" fmt "", "", ##__VA_ARGS__)
#define I(fmt, ...) hvml_log_printf(__FILE__, __LINE__, __FUNCTION__, stderr, 'I', "%s" fmt "", "", ##__VA_ARGS__)
#define W(fmt, ...) hvml_log_printf(__FILE__, __LINE__, __FUNCTION__, stderr, 'W', "%s" fmt "", "", ##__VA_ARGS__)
#define E(fmt, ...) hvml_log_printf(__FILE__, __LINE__, __FUNCTION__, stderr, 'E', "%s" fmt "", "", ##__VA_ARGS__)
#define V(fmt, ...) hvml_log_printf(__FILE__, __LINE__, __FUNCTION__, stderr, 'V', "%s" fmt "", "", ##__VA_ARGS__)
